  ...
  $.each(data.result, function(ind, json) {
    ...
    $.each(json[2].plext.markup, function(ind, markup) {
      ...
      case 'TEXT':
        ...
        // field was originally created. Therefore itÅfs not clear which
      ...
      case 'PLAYER':
        ...
        break;
      case 'PORTAL':
        // link messages are Ågplayer linked X to YÅh and the player is at
        // X.
    ...
    // thereÅfs some data already. Need to find correct place to insert.
    var i;
    ...
    // if itÅfs the same location, just update the timestamp. Otherwise
    // push as new event.
    if(sameLocation) {
